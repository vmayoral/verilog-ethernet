...
# LEDs
set_property -dict {PACKAGE_PIN F8 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 8} [get_ports {led[0]}]  ;# HPA14P, som240_1_d13
set_property -dict {PACKAGE_PIN E8 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 8} [get_ports {led[1]}]  ;# HPA14N, som240_1_d14
...
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports reset]  ;# som240_1_c15
...
# SFP+ Interface
set_property -dict {PACKAGE_PIN T2  } [get_ports sfp0_rx_p] ;# GTH_DP2_C2M_P, som240_2_b1
set_property -dict {PACKAGE_PIN T1  } [get_ports sfp0_rx_n] ;# GTH_DP2_C2M_N, som240_2_b2
set_property -dict {PACKAGE_PIN R4  } [get_ports sfp0_tx_p] ;# GTH_DP2_M2C_P, som240_2_b5
set_property -dict {PACKAGE_PIN R3  } [get_ports sfp0_tx_n] ;# GTH_DP2_M2C_N, som240_2_b6

set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVDS_25} [get_ports clk_125mhz_p] ;# GTH_REFCLK0_C2M_P via U90, SOM240_2 C3
set_property -dict {PACKAGE_PIN Y5 IOSTANDARD LVDS_25} [get_ports clk_125mhz_n] ;# GTH_REFCLK0_C2M_N via U90, SOM240_2 C4
# set_property -dict {PACKAGE_PIN Y10  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 8} [get_ports sfp0_tx_disable_b]  ;# HDB19, SOM240_2_A47
set_property -dict {PACKAGE_PIN Y10 } [get_ports sfp0_tx_disable_b]  ;# HDB19, SOM240_2_A47
